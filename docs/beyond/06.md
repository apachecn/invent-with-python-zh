...
![](img/74e8cef2461199147c9866361cd78f1c.png)导致程序崩溃的代码显然是错误的，但是崩溃并不是程序中问题的唯一指示器。其他迹象可能表明存在更微妙的错误或不可读的代码。就像气体的味道可以指示气体泄漏或者烟雾的味道可以指示火灾一样，*代码味道*是指示潜在错误的源代码模式。代码气味并不一定意味着存在问题，但它确实意味着您应该调查您的程序。
