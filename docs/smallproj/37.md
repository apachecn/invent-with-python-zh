...
![](../Images/9d995d63aaead72cad01120081eb8f75.png)这个可视化程序有一个粗糙的物理引擎，模拟沙子通过沙漏的小孔落下。沙子堆积在沙漏的下半部分；然后把沙漏翻过来，重复这个过程。

## 行动中的计划

图 36-1 显示了运行*沙漏. py* 时的输出。

![f36001](../Images/15e1daa91d334672458254f0c8896454.png)
