...
![](../Images/9d995d63aaead72cad01120081eb8f75.png)这个项目的特点是使用三角函数的 3D 立方体旋转动画。您可以在自己的动画程序中修改 3D 点旋转数学和`line()`功能。
...
![f62001](../Images/e7939487302529e512bc4b0e074ff1d3.png)
...
![f62002](../Images/f63f730478b6e442ca208039940b8d2b.png)
