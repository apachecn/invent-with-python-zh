...
![](../Images/9d995d63aaead72cad01120081eb8f75.png)21 点，也称为 21 点，是一种纸牌游戏，玩家试图在不超过 21 点的情况下尽可能接近 21 点。这个程序使用用文本字符绘制的图像，称为 *ASCII art* 。美国信息交换标准码(ASCII)是 Unicode 取代之前计算机使用的文本字符到数字代码的映射。本程序中的扑克牌是 ASCII 艺术的一个例子:
