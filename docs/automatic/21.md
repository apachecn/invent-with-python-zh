...
要尝试这些功能，请打开一个图形绘制应用，例如 Windows 上的微软画图、MacOS 上的 Paintbrush 或 Linux 上的 GNU 画图。（如果您没有绘图应用，可以在使用在线应用。）我将使用 PyAutoGUI 在这些应用中绘图。
