...
要尝试这些功能，请打开一个图形绘制应用程序，例如 Windows 上的 MS 画图、macOS 上的 Paintbrush 或 Linux 上的 GNU Paint。（如果您没有绘图应用程序，可以在使用在线应用程序。）我将使用 PyAutoGUI 在这些应用程序中绘图。
