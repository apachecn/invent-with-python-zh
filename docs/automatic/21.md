...
无论您是从 Mu、IDLE 还是终端运行 Python 程序，都要打开该应用程序。然后打开“系统偏好设置”并转到“辅助功能”标签。当前打开的应用程序将出现在“允许下面的应用程序控制您的电脑”标签下。检查 Mu、IDLE、终端或您用来运行 Python 脚本的任何应用程序。系统会提示您输入密码以确认这些更改。
...
要尝试这些功能，请打开一个图形绘制应用程序，例如 Windows 上的微软画图、MacOS 上的 Paintbrush 或 Linux 上的 GNU 画图。（如果您没有绘图应用程序，可以在使用在线应用程序。）我将使用 PyAutoGUI 在这些应用程序中绘图。
