...
在 Word for Windows 中，可以通过按下<small class="calibre11">CTRL</small>-<small class="calibre11">ALT</small>-<small class="calibre11">SHIFT</small>-S 显示样式窗格来查看样式，看起来就像图 15-5 。在 macOS 上，你可以通过点击**查看**样式**菜单项来查看样式面板。**
