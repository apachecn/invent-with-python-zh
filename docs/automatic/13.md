...
除了查看网页的源代码，您还可以使用浏览器的开发工具浏览网页的 HTML。在 Chrome 和 Internet Explorer for Windows 中，已经安装了开发者工具，你可以按 F12 让它们出现(见图 12-4 )。再次按 F12 将使开发者工具消失。在 Chrome 中，你也可以通过选择**视图****开发者****开发者工具**来调出开发者工具。在 macOS 中，按下![image](img/63fa039eb8d3fb51d4da86e303dea1be.png) - `选项`-我会打开 Chrome 的开发者工具。
