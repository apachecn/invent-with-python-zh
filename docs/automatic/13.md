...
除了这里描述的功能之外，Selenium还可以做更多的事情。它可以修改你浏览器的 cookies，抓取网页截图，运行自定义 JavaScript。要了解这些特性的更多信息，您可以访问位于[`selenium-python.readthedocs.org`](https://selenium-python.readthedocs.org/)的文档。
