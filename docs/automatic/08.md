...
虽然我鼓励您将示例代码输入到交互式 shell 中，但是您也应该使用基于 web 的正则表达式测试器，它可以向您展示正则表达式是如何准确匹配您输入的一段文本的。我推荐 https://pythex.org/T2 的测试人员。
...
你可以在的官方 Python 文档中找到更多。另一个有用的资源是 https://www.regular-expressions.info/的教程网站。
...
[8](#calibre_link-1152) 。正则表达式中的`|`字符表示什么？
