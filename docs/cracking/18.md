...
要计算 `dictionary.txt` 字典文件中每个单词的单词模式，从`www.nostarch.com/crackingcodes`的[T5T7】下载*makewodpatterns . py*。确保这个程序和 `dictionary.txt` 都在保存本章的 `simpleSubHacker.py` 程序的文件夹中。](https://www.nostarch.com/crackingcodes/)
